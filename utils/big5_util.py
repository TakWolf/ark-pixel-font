...
def get_alphabet_other():
    """
    0xA140 ~ 0xA3BF
    标点符号、希腊字母、特殊符号，包括在 0xA259 ~ 0xA261 安放了九个计量用汉字：兙兛兞兝兡兣嗧瓩糎。
    """
    alphabet = []
...
def get_alphabet_level_1():
    ...
    0xA440 ~ 0xC67E
    常用汉字（5401 字）
    字集来源除教育部“常用国字标准字体表”所列 4808 字外，并优先收编国中、国小教科书中常用字 587 字及异体字 6 字。
    先按笔画再按部首排序。
    """
    alphabet = []
...
def get_alphabet_level_2():
    ...
    0xC940 ~ 0xF9D5
    次常用汉字（7652 字）
    字集来源除教育部“次常用国字标准字体表”所列 6330 字外，并筛选编入教育部“罕用国字标准字体表”表中使用频率较高之 1320 字。
    先按笔画再按部首排序。
    """
    alphabet = []
